            ...
            <div class="row">
              <div class="col-lg-10 col-xl-7 mx-auto">
                ...
                <br />
                    ...
                    <div class="mb-3">
                        <input  id="number"type="text" placeholder="Nomor Whatsapp Anda" required="" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary" />
                    </div>
                    <div>
                        <input  id="tujuan" type="mobile" placeholder="Tujuan Kedatangan" required="" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary" />
                    </div>
                    <br />
